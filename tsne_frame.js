...
function showSelectedImage(embs,idx) {
    ...
    if (frame) {
        ...
        // var query_url=image_url+activities[frame.seq_labels]+"_videos/rm_noise/frames/"+frame.names.slice(2,-1)+FormatNumberLength(frame.steps,4)+".jpg";
        // var reference_url=image_url+activities[frame.seq_labels]+"_videos/rm_noise/frames/"+reference[frame.seq_labels]+FormatNumberLength(frame.dtw,4)+".jpg";
